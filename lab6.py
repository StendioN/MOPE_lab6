...
Y1 = [round(
    8.4 + 8.5 * X1[i] + 5.7 * X2[i] + 9.7 * X3[i] + 8.9 * X1_kv[i] + 0.2 * X2_kv[i] + 0.5 * X3_kv[i] + 2.0 * X12[i]
    + 0.7 * X13[i] + 4.3 * X23[i] + 9.7 * X123[i] + random.randrange(-10, 10) - 5, 3) for i in range(15)]
Y2 = [round(
    8.4 + 8.5 * X1[i] + 5.7 * X2[i] + 9.7 * X3[i] + 8.9 * X1_kv[i] + 0.2 * X2_kv[i] + 0.5 * X3_kv[i] + 2.0 * X12[i]
    + 0.7 * X13[i] + 4.3 * X23[i] + 9.7 * X123[i] + random.randrange(-10, 10) - 5, 3) for i in range(15)]
Y3 = [round(
